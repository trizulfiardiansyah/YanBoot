...
const YnBoot= '『trizulfiardiansyah』'; 
const instagram = '@trizlfiardiansyh_'; 
const nomer = 'Wa.me/+6285765964082'; 
const aktif = 'Tergantung kuota'; 
const groupwhatsapp = 'CoomingSon'; 
const youtube = 'NANTI DIBUAT-_-'; 
